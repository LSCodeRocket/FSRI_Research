...
def display_comparison_graph():
    ...
    for i in range(int(sys.argv[2])):
        ...
        axes[1].set_xlabel("Horizontal Distance ($\\myu m$)")
        axes[1].set_ylabel("Depth ($\\myu m$)")
        axes[1].legend()
        ...
        axes[2].set_xlabel("Horizontal Distance ($\\myu m$)")
        axes[2].set_ylabel("Depth ($\\myu m$)")
        ...
        axes[0].set_ylabel("Indenter Depth ($\myu m$)")
